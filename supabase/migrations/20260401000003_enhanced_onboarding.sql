-- Enhanced onboarding fields for sellers and managers

-- Seller profile fields on User table
ALTER TABLE "User"
  ...
  ADD COLUMN IF NOT EXISTS "companyAffiliation" text,
...
ALTER TABLE "Company"
  ...
  ADD COLUMN IF NOT EXISTS "companyType" text
    CHECK ("companyType" IN ('independent', 'franchise', 'virtual')),
