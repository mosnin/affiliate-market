...
DROP FUNCTION IF EXISTS book_demo_atomic(UUID, UUID, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TIMESTAMPTZ, TIMESTAMPTZ, UUID, TEXT);
DROP FUNCTION IF EXISTS create_space_with_defaults(UUID, TEXT, TEXT, TEXT, UUID, UUID, TEXT, TEXT, TEXT, JSONB);
DROP FUNCTION IF EXISTS create_company_with_owner(TEXT, UUID);
