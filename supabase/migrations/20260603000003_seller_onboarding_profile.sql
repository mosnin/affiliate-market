-- Extend AIUserProfile with the fields captured by the new seller onboarding:
--   role          — solo agent / team lead / company owner
--   zipCode       — primary market ZIP, used by Cola for market context
--   leadSources   — channels the seller uses to acquire leads (zillow, facebook, …)
--
