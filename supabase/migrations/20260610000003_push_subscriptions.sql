-- Web push (VAPID) subscriptions — one row per browser/device a seller has
...
-- new lead / demo / deal / follow-up fires.
--
...
-- Defaults true so a seller who subscribes a device starts receiving push
