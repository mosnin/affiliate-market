-- Intake trust signals: optional seller-supplied compliance slots that
-- render in the public intake chat footer. Cola provides the rendering
-- slot; the seller/company supplies the actual legal text — we never
-- inject legal copy on their behalf.
--
--   intakeLicenseNumber       — real-estate license # (e.g. "TX-RE-12345")
--   intakeFairHousingNotice   — company-supplied Fair Housing statement
