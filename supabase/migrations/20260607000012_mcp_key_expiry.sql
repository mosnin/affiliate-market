...
-- meant the attacker had read-only Composio-MCP access to the seller's
...
--     enough that sellers who set-and-forget don't break their Claude
...
--     (e.g. now() + 1y) and notify sellers. Not done here — that's a
