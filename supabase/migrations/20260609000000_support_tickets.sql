-- Support tickets — a seller submits a help request from inside the app; it
-- lands in the admin dashboard where an admin triages it.
--
-- spaceId / userId link the ticket to the submitting seller's workspace and
...
-- Seller "my tickets" view filters by the submitting user, newest-first.
