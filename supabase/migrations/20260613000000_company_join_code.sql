-- Backfill the "Company"."joinCode" column.
--
...
-- missing it, which made join-by-code (app/api/manager/join/route.ts) and
-- join-code regeneration (app/api/manager/join-code/route.ts) throw
