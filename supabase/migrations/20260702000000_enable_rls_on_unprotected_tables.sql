...
-- through PostgREST. The tables below hold workspace/PII data (manager<->Cola
...
-- Realtime touches only Contact / Deal / DealStage / Demo, already scoped in
...
ALTER TABLE IF EXISTS "ManagerConversation"    ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS "ManagerMessage"         ENABLE ROW LEVEL SECURITY;
