 ...
 * (`onboarding-seller-v2.tsx`). The legacy `onboarding-seller.tsx`
 * keeps its own inline copies on purpose: it's the live flow, slated
 * for deletion once V2 ships to all sellers, and refactoring code
...
export type Role = 'solo' | 'team_lead' | 'company_owner';
