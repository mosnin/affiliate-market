    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-1.5">
        ...
        <Input
          ...
          disabled={!isOwner}
        />
        <p className={CAPTION}>Optional. Shown on your company profile.</p>
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <div
          ...
          onClick={() => isOwner && document.getElementById('manager-logo-upload')?.click()}
        >
          {logoUrl ? (
        ...
        <input
          ...
          onChange={async (e) => {
            ...
            try {
              ...
              // Use onboarding upload endpoint — manager-only accounts may not have a Space
      ...
      <div className="space-y-3 pt-3">
        <div className="flex items-start justify-between gap-3">
          <div className="space-y-0.5">
            ...
            <p className={CAPTION}>Shown on intake pages for sellers under your company.</p>
          </div>
          {isOwner && (
            <button
              type="button"
              onClick={() => {
                setPrivacyPolicyHtml(generatePrivacyPolicy(name, 'company'));
        ...
        <RichTextEditor
          ...
          placeholder="Enter your company privacy policy here or click 'Generate template' to start..."
          disabled={!isOwner}
        />
        <p className={CAPTION}>
