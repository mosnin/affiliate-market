...
/**
 * "Draft impact" — single card on the manager dashboard. Reports how Cola's
 * drafts landed across the company over the trailing 30 days.
 *
...
function DraftImpactBody({ stats }: { stats: DraftStats }) {
  ...
  // nothing for the manager to misread as "Cola is broken."
  if (stats.total === 0) {
    return (
    ...
    <>
      ...
      {hasOutcome && (
        <p className="text-xs text-muted-foreground">
          Correlation only — the deal moved after the draft sent. Cola didn&apos;t
