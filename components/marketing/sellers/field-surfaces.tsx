...
/**
 * FieldSurfaces — the "reach Cola wherever the work is" row for /sellers.
 *
 ...
 * one icon, one line). The idea: a solo seller is rarely at a desk; Cola is
...
const SURFACES = [
  ...
  },
  {
    ...
    body: 'install Cola to your home screen. the whole workspace, no app store, online or driving between doors.',
  },
  {
    icon: Monitor,
    title: 'at the office.',
