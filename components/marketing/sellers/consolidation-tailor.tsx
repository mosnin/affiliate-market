...
/**
 * The two closing payoff sections for /sellers, kept together because they
 * answer the same buyer objection from two angles: "why move?" and "will it
 * fit how I work?"
 *
 *   1. OnePlace — the data-consolidation payoff. The seller stops bouncing
 *      between six tabs; inbox, people, pipeline, calendar, products, files,
 *      and studio are one workspace, and Cola keeps them in sync. Rendered
 ...
 *
 *   2. TailorIt — repetitive work handled, fit to the seller's existing
 *      workflow. Grounded in real Cola tools: drafting in your voice,
 *      follow-ups it sets, demos it books, the pipeline it keeps current —
...
const ROOMS = [
  ...
  { icon: CalendarCheck, label: 'calendar', note: 'demos and follow-ups in the week you already keep.' },
  { icon: Building2, label: 'products', note: 'listings as records: offers, specs, who saw what.' },
    ...
    <section className="relative mx-auto max-w-7xl px-6 py-24 md:px-8 md:py-32">
      <Reveal className="max-w-3xl">
        ...
        <p className="mt-4 max-w-xl text-lg leading-relaxed text-foreground/55">
          ...
          Cola keeps every corner of it current.
        </p>
      </Reveal>
...
/** Repetitive work handled, fit to how the seller already works. */
const TAILORED = [
  {
    icon: PenLine,
    title: 'drafts in your voice.',
    body: 'Cola learns how you actually write and composes the reply you would have typed, then stops for your read.',
  },
  {
    icon: Bell,
  ...
  },
  {
    ...
    body: 'listing copy, the email blast, the social post, all generated from the product record and scheduled to your channels.',
  },
  {
    icon: ShieldCheck,
    title: 'autonomy you grant.',
    body: 'approval-first on every send by default. trust a task, and hand Cola that one, per tool, on your terms.',
  },
];
    ...
    <section className="relative mx-auto max-w-7xl px-6 py-24 md:px-8 md:py-32">
      <Reveal className="max-w-3xl">
        ...
        <p className="mt-4 max-w-xl text-lg leading-relaxed text-foreground/55">
          ...
          decide how much Cola handles, and you can change your mind anytime.
        </p>
      </Reveal>
