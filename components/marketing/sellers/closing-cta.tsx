...
/**
 * ClosingCTA — the final ask on /sellers. Same full-bleed dark panel and warm
 * floor-wash as the homepage's TryFreeCTA, so the page lands in the same family.
 * The seller has seen the whole story by now; this is the one place two CTAs
        ...
        <div className="relative overflow-hidden rounded-[2rem] bg-[#171310] px-8 py-16 text-center md:px-16 md:py-24">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-5 max-w-xl text-lg text-white/55">
              seven days free. no credit card. bring your inbox and let Cola do
              the rest.
            </p>
