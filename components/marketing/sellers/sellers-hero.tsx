...
/**
 * SellersHero — the /sellers opener. Same atmosphere as the homepage hero:
 * the Cola-orange ASCII blob drifting behind, a center-protect radial keeping
 * the headline zone calm, a settle-into-page gradient at the floor. The promise
 * here is narrower than home's: Cola is the teammate who works the field with
