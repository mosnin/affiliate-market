...
/**
 * CompaniesContent — the body of `/companies`, composed entirely from the
 ...
 *   - empower the floor          → the seller's own Cola workspace (home)
 *   - lead routing / reassign    → lib/ai-tools/tools/assign-lead-to-seller.ts
 ...
 *   - team chat / @cola        → TeamChatDiagram (per-deal channels, mention)
 ...
 * the diagrams carry orange only on the Cola authorship badge. Buttons, links,
 ...
 *  one product. Primary → seller signup; secondary → /demo (prominent here,
 *  because managers want a walkthrough before they move a floor). */
 ...
 *  the other, alternating. Same rhythm as the home/sellers pages. */
function FeatureRow({
  eyebrow,
  title,
  sub,
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 pt-24 pb-14 md:px-8 md:pt-36 md:pb-24">
        ...
        >
          ...
          >
            ...
            on one surface. Cola routes the leads, tracks what the floor is
...
const EMPOWER = [
  {
    ...
    body: 'each seller keeps their own Cola workspace. it reads their inbox, drafts replies in their voice, and keeps every deal current. you add a team layer on top; you never take their workspace away.',
  },
  {
    icon: TimerReset,
    title: 'time, compressed.',
    body: 'first-touch, follow-ups, demo booking, deal updates. the repetitive work runs itself. the floor spends its hours on the conversations that close, not on the busywork around them.',
  },
  {
    icon: ShieldCheck,
    title: 'nothing leaves without a name on it.',
    body: 'Cola drafts; the seller approves. every send goes through the person whose name is on it. the agent does the work; the floor stays in the driver’s seat.',
  },
];
    ...
    >
      <Reveal className="max-w-3xl">
        ...
        <p className="mt-4 max-w-xl text-lg leading-relaxed text-foreground/55">
          a company doesn&apos;t fail on features. it fails when the sellers
          stop logging in. so Cola makes the floor faster first, and gives you
 ...
 *  pipeline_summary. No invented metrics — these are real verbs Cola has. */
const SIGNALS = [
          ...
          <div className="relative">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-[15px] leading-relaxed text-white/55">
                ask Cola how the floor is doing and it reads the real work,
            ...
            <p className="mt-6 flex items-center gap-2 text-[13px] text-white/45">
              ...
              flag any deal for your sign-off. Cola opens the review, you make
              the call.
            </p>
          </div>
        </div>
 ...
 *  try-free-cta but keeps the company-flavored second option (Book a demo). */
function ClosingCta() {
  return (
    <section className="mx-auto max-w-7xl px-6 py-12 md:px-8 md:py-16">
      <Reveal>
        <div className="relative overflow-hidden rounded-[2rem] bg-[#171310] px-8 py-16 text-center md:px-16 md:py-24">
          ...
          <div className="relative">
            <h2 className="mx-auto max-w-3xl font-title text-[clamp(2rem,5vw,3.75rem)] font-normal leading-[1.04] tracking-[-0.018em] text-white">
              bring your floor to Cola.
            </h2>
            <p className="mx-auto mt-5 max-w-xl text-lg text-white/55">
              the sellers keep what they already do. the company sees what it
...
export function CompaniesContent() {
  return (
    <>
      ...
      {/* Lead distribution — auto-assign and hand-pick to the right seller. */}
      <section
      ...
      >
        <FeatureRow
          ...
          title={<>every lead, the right seller.</>}
          sub="auto-assign by territory and load, or hand-pick the seller and write the brief. Cola can reassign a lead to anyone on the floor with a reason logged to the activity trail."
          points={[
            'auto-assignment, weighted by who has room.',
            'hand-pick and reassign, always your override.',
            'every assignment logged, with the reason, per seller.',
          ]}
      ...
      >
        <FeatureRow
          ...
          sub="ask Cola to roll up any seller's last week: deals active, won, and lost; new and hot leads; drafts pending and their approval rate. the numbers come from the work, not a status meeting."
          points={[
            'per-seller rollups across deals, leads, and drafts.',
        ...
        <Reveal className="mt-12 flex flex-wrap items-center gap-3">
          <span className="inline-flex items-center gap-2 text-[13px] text-foreground/55">
            ...
            grounded in the seller&apos;s real activity, every figure.
          </span>
        </Reveal>
      </section>
      ...
      <section className="relative mx-auto max-w-7xl px-6 py-24 md:px-8 md:py-32">
        <FeatureRow
          ...
          sub="approved templates the whole floor reaches for. Cola adapts each one to the lead and the seller's voice, so a template never lands as a stamp, and the high-risk replies stay on-brand."
          points={[
            'a company-wide library, written once.',
      ...
      {/* Team chat — talk shop on the same page, @cola in channel. */}
      <section
        id="team-chat"
        className="relative mx-auto max-w-7xl px-6 py-24 scroll-mt-28 md:px-8 md:py-32"
      >
        <FeatureRow
          ...
          sub="channels that live with the deal, not next to it. @cola in a channel and it answers in line: where the deal stands, a drafted reply, a number pulled from the record. no tab-switching."
          points={[
            'per-deal channels, archived on close.',
            'mention @cola to pull it into the thread.',
            'general channels for the floor; Cola stays out unless invited.',
          ]}
      ...
      <section className="relative mx-auto max-w-7xl px-6 py-24 md:px-8 md:py-32">
        <FeatureRow
          ...
          sub="three roles, no permissions matrix. Owner runs the show, Admin manages the floor, Member is the seller doing the work. admins see the rollup; private drafts and notes stay private."
          points={[
