 ...
 * Cola. Made theme-aware: a deep charcoal card in both modes (it reads as a
 * deliberate dark base on the light canvas, same call as the home stats card)
 * with brand-orange small-caps column heads. Cola routes only.
 */
...
const footerLinks = {
  ...
  company: [
    ...
    { label: 'Log in', href: '/login/seller' },
  ],
  legal: [
      ...
      <div className="mx-auto max-w-7xl overflow-hidden rounded-marketing-3xl bg-[#111113] text-white">
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            ...
            <div className="col-span-2 space-y-4 md:col-span-1">
              <Link href="/" className="flex items-center gap-2" aria-label="Cola home">
                ...
                <img src="/logo-white.png" alt="Cola" className="block h-5 w-auto" />
              </Link>
              <p className="max-w-xs text-sm text-white/50">
                The agentic OS for real-estate agents and companies. The
        ...
        <div className="flex flex-col items-center gap-2 border-t border-white/10 px-6 py-4 sm:flex-row sm:justify-between sm:px-8 lg:px-12">
          <p className="text-xs text-white/40">
            &copy; {new Date().getFullYear()} Cola. All rights reserved.
          </p>
          <Link
            href="/status"
