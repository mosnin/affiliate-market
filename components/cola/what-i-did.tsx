...
const ACTION_META: Record<string, { verb: string; icon: LucideIcon }> = {
  ...
  packet_drafted: { verb: 'drafted a product packet for', icon: MessageSquare },
...
/**
 * "What I did" — proof of work. Most-recent autonomous actions Cola
 * completed without human intervention. First section of the dispatch
 * console so the seller opens the page and immediately sees the agent
 * earned its keep.
 *
