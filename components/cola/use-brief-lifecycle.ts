...
/**
 * The brief is a moment, not a surface. It exists to wake the seller
 ...
 * seller doesn't lose the brief mid-read by accident.
 */
...
interface UseBriefLifecycleArgs {
  ...
  /** Manual collapse override — set true when the seller explicitly
...
export function formatProgress(
  ...
  // The receipt has to sound like a seller would talk about their
