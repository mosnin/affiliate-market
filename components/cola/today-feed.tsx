...
/**
 * The default surface — focus mode. One focal item at a time. The seller
 * lands on /cola and sees ONE thing waiting on them with Send / Edit /
 ...
 *
 * The seller signal said simplicity wins. This is more simplicity — five
...
export function TodayFeed({
  ...
  slug: string;
  /** True when the seller has done nothing yet — triggers day-one welcome. */
  isFresh?: boolean;
  firstName?: string;
