...
const STORAGE_KEY = 'cola.tip.howItWorks.dismissedAt';

/**
 * One-time explainer that surfaces the agent's autonomous loop, since the UI
 * alone doesn't make it obvious that Cola runs in the background. Shown on
 ...
 */
export function HowColaWorksTip() {
      ...
      <div className="flex items-start gap-2.5">
        ...
        <div className="space-y-0.5 leading-relaxed">
          ...
          <p className="text-[13px] text-muted-foreground">
            Cola sweeps your pipeline every 15 minutes and leaves drafts and
