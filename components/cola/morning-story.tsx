...
/**
 * Cola-voiced fallback sentences. Called when the API is unavailable or
...
/**
 * The /cola home's one sentence. Phase 5 made it expand into an action
 * panel; Phase 7 made the panel actually do work — compose actions now
 * draft, preview, and send inline. The seller never leaves the home.
 */
