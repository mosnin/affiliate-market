...
| File | Surface |
|---|---|
| `card-inbox.png` | inbox triage — Cola surfacing the one to read first |
| `card-draft.png` | Cola drafting a reply in your voice |
| `card-leads.png` | lead scoring / people |
| `card-calendar.png` | demo booking on the calendar |
...
| `logo-*.svg` | monochrome SVGs of what Cola connects to (Gmail, Outlook, Google Calendar, …) or real company logos you have rights to |
