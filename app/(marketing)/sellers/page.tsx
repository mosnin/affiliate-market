...
import { SellersHero } from '@/components/marketing/sellers/sellers-hero';
import { FieldSurfaces } from '@/components/marketing/sellers/field-surfaces';
import { FeatureRow } from '@/components/marketing/sellers/feature-row';
import {
  OnePlace,
  TailorIt,
} from '@/components/marketing/sellers/consolidation-tailor';
import { ClosingCTA } from '@/components/marketing/sellers/closing-cta';
import {
    ...
    <div className="bg-muted text-foreground">
      ...
      >
        <Reveal className="max-w-3xl">
          ...
          <p className="mt-4 max-w-xl text-lg leading-relaxed text-foreground/55">
            you&rsquo;re rarely at a desk. Cola is a tap away on whatever screen is
      ...
      <div className="relative mx-auto max-w-7xl space-y-24 px-6 py-12 md:space-y-32 md:px-8 md:py-16">
        ...
        <FeatureRow
          ...
          sub="Cola reads the thread, writes the reply the way you actually write, and stops. you read it, you press send. or you don't."
          points={[
        ...
        <FeatureRow
          ...
          sub="reply with a time. Cola checks your availability, puts it on the calendar, sends the confirmation, and writes it back to the deal. no tab-switching."
          points={[
        ...
        <FeatureRow
          ...
          sub="drag a card to the next stage; Cola keeps the value, the dates, and the counterparty in sync. the board reflects reality, not yesterday."
          points={[
        ...
        <FeatureRow
          ...
          sub="Gmail and Outlook plug in. Cola reads every inbound, weighs it against your live deals, and quietly lifts the one to look at first. it stays quiet when nothing's worth surfacing."
          points={[
        ...
        <FeatureRow
          ...
          sub="emails, demos, notes, drafts, replies, assembled chronologically per contact. you scroll the relationship; you don't reconstruct it from memory."
          points={[
            'demos and meetings logged as they happen.',
            'Cola-authored actions tagged on the timeline.',
            'ask Cola to recall the history and it does.',
          ]}
      ...
      >
        <Reveal>
          ...
          <p className="mx-auto mt-5 max-w-xl text-lg leading-relaxed text-foreground/55">
            Cola does the work; you make the call. approval-first by default,
