...
export const metadata: Metadata = { title: 'Sign Up — Cola' };
...
export default async function SignUpPage({
  ...
  const isManager = intent === 'manager';
  const redirectIntent = isManager ? 'manager' : 'seller';
  const signInBase = isManager ? '/login/manager' : '/login/seller';
  ...
  return (
    <AuthPageLayout
      ...
      variant={isManager ? 'manager' : 'seller'}
    >
