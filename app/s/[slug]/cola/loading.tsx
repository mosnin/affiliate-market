/**
 * /s/[slug]/cola/loading.tsx — Suspense fallback for the Cola chat home.
 *
 * Mirrors the empty-state hero in cola-workspace.tsx so the seller sees
...
export default function ColaLoading() {
  return (
    <div className="relative flex flex-col h-full min-h-0">
      ...
      <span className="sr-only">Loading Cola…</span>
    </div>
  );
}
