...
export default async function ColaPage({
  ...
  // `prefill` populates the composer but does NOT auto-send — the seller
  // finishes the sentence themselves. Used by "or just tell Cola →" shortcuts
  ...
  try {
    ...
    if (targetConvId) {
      // Verify the requested conversation belongs to THIS seller space and is
  ...
  // morning when the seller has zero active integrations AND Composio is
