/**
 * /cola/inbox — the merged Drafts + Approvals surface.
 *
 * Drafts and Approvals share one intent: "Cola paused, waiting on
 * your tap." Drafts = a message awaiting send-off. Approvals = a task
 * awaiting yes/no. Two mechanisms, one seller action: decide. One
 ...
 * approvals).
 *
 * /cola/drafts and /cola/approvals both redirect here so bookmarks
 * stay live.
 */
...
export default async function ColaInboxPage({
  params,
}: {
