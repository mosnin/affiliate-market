 ...
 */
export default async function ProductsCommissionsPage({
  params,
}: {
  ...
  return (
    <div className={cn(PAGE_RHYTHM, 'max-w-5xl mx-auto pb-12')}>
      {/* Header — H1 + Cola-voiced subtitle naming the loudest money fact.
          The stat strip below is the supporting evidence. Commissions is its
          own destination now (the standalone Products list has been cut),
