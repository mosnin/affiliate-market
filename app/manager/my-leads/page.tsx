...
export const metadata: Metadata = { title: 'My Leads — Cola' };
    ...
    return (
      <div className="space-y-6 max-w-5xl mx-auto pb-56 md:pb-24">
        <header className="space-y-1.5">
          ...
          <p className={BODY_MUTED}>{company.name} hasn&rsquo;t routed anything yet.</p>
        </header>
    ...
    <div className="space-y-6 max-w-5xl mx-auto pb-56 md:pb-24">
      ...
      {leads.length === 0 ? (
        <div className="rounded-xl border border-dashed border-border/70 bg-muted/20 px-5 py-12 text-center">
          ...
          <p className={cn(BODY_MUTED, 'mt-1.5')}>
            When {company.name} routes a lead to you, I&rsquo;ll land it here.
          </p>
        </div>
      ) : (
