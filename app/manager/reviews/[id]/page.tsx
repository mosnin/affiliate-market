...
export default async function ManagerReviewDetailPage({ params }: PageProps) {
  ...
  //    different company — we must not leak existence across companies.
  ...
  if (!reviewRow || reviewRow.companyId !== ctx.company.id) {
    notFound();
  }
